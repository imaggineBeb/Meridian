(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            if (rangeItems.length) rangeItems.forEach((rangeItems => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper", ".swiper-text", ".swiper-one", ".images-showroom__slider", ".images-showroom__thumbs", ".other-showroom__slider")) {
                new core(".ship__slider", {
                ...
                const myTextSlider = new core(".swiper-text", {
                ...
                const myImageSlider = new core(".swiper-one", {
                ...
                const thumbsSwiper = new core(".images-showroom__thumbs", {
                    modules: [ Navigation, Scrollbar, Thumb, Controller, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 5,
                    spaceBetween: 20,
                    speed: 800,
                    navigation: {
                        prevEl: ".images-showroom-prev",
                        nextEl: ".images-showroom-next"
                    },
                    breakpoints: {
                        1140: {
                            slidesPerView: 3,
                ...
                new core(".images-showroom__slider", {
                ...
                new core(".other-showroom__slider", {
                    modules: [ Navigation, Scrollbar ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
...
***************************************************************************** */
        ...
        da.init();
        const formSearch = document.querySelector(".search-form__item");
        const formBtn = document.querySelector(".search__btn");
        if (formSearch) formBtn.addEventListener("click", (function(e) {
            formSearch.classList.toggle("_active");
        }));
        if (null !== document.querySelector(".banner")) document.addEventListener("DOMContentLoaded", (() => {
            const bannerTimer = new Date("Jan 1 2023 00:00:00");
            const daysVal = document.querySelector(".time-banner__days .time-banner__val");
            const hoursVal = document.querySelector(".time-banner__hours .time-banner__val");
            const minutesVal = document.querySelector(".time-banner__minutes .time-banner__val");
            const secondsVal = document.querySelector(".time-banner__seconds .time-banner__val");
            const timeCount = () => {
                let now = new Date;
                let leftUntil = bannerTimer - now;
        ...
        function clearAllFormInputs() {
            ...
            let polya = form.getElementsByTagName("input");
            for (let input of polya) input.value = "";
        }
        let script_button = document.getElementById("button");
        if (script_button) script_button.addEventListener("click", clearAllFormInputs);
        if (document.querySelector(".catalog__separate-button")) document.querySelector(".catalog__separate-button").addEventListener("click", (function(e) {
            if (window.innerWidth < 992) document.querySelector(".catalog__filter").classList.toggle("_active");
        }));
        const itemBorder = document.querySelector(".questions__spollers");
        const itemSpollerButton = document.querySelector(".questions__button");
        if (itemSpollerButton.classList.contains("._spoller-active")) itemBorder.classList.add(".border-orange"); else itemBorder.classList.add(".border-orange");
        window["FLS"] = true;
        isWebp();
        addTouchClass();
        menuInit();
